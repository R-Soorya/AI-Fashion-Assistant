...
Generate a list of 5-6   {preference['dress_type']} outfit combinations for a {preference['gender']}, {preference['body_shape']} body shape, {preference['skin_tone']} skin tone, and {preference['height']} height.
