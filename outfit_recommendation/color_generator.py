...
color_data = pd.read_csv(r'E:\Final Year Project\app\outfit_recommendation\model\color_embeddings.csv')

model = SentenceTransformer(r'E:\Final Year Project\app\outfit_recommendation\model\sentence_transformer')
...
def generate_color_image(final_response, output_dir="output_images", size=(500, 500)):

    output_dir = r'E:\Final Year Project\app\static\color'
